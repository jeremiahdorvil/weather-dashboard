const APIKey = "a2eca95f70da5fcc677c9425d12a6dfc";
let forcastURL = "api.openweathermap.org/data/2.5/forecast?lat=" + latitude + "&lon=" + longitude + "&appid=" + APIKey;
// const timeDisplayEl = "#currentDate";
...
var resultContentEl = document.querySelector('#content'); //for 5 days weather
var searchFormEl = document.querySelector('#search-form');
var searchHistoryEl = document.querySelector('#history');
var fiveForecastEl = document.querySelector('#five-day');
...
//   resultContentEl.innerHTML = "";
  ...
  fetch(queryUrl)
    ...
    .then(function (data) {
        ...
        h3.textContent = "Temperature: " + data.list[0].main.temp;


        currentWeather.append(h1, h3);
